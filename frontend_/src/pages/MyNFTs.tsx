...
const MyNFTs: React.FC = () => {
  ...
  const handleConfirmTransfer = async () => {
    if (!nftToTransfer || !recipientAddress) return;
    ...
    try {
      const entryFunctionPayload = {
        ...
        type_arguments: [],
        arguments: [marketplaceAddr, nftToTransfer.id.toString(), recipientAddress],
      };
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        footer={[
        <Button key="cancel" onClick={handleTransferCancel}>Cancel</Button>,
        <Button key="transfer" type="primary" onClick={handleConfirmTransfer}>Transfer</Button>,
      ]}
    >
      {nftToTransfer && (
      <>
        <p><strong>NFT ID:</strong> {nftToTransfer.id}</p>
        <p><strong>Name:</strong> {nftToTransfer.name}</p>
        <p><strong>Description:</strong> {nftToTransfer.description}</p>
